        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                    ...
                    'gst_amount' => format_price(convert_price($data->orderDetails->sum('gst_amount'))),
                    'gstin' => get_seller_gstin($data),
                    'gst_applicable'=> is_numeric(optional($data->orderDetails->first())->gst_amount) ? 1 : 0,
