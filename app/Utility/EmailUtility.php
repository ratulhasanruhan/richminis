...
class EmailUtility
{
    ...
    public static function customer_registration_email($emailIdentifier, $user, $password = null){
        ...
        // Replace hardcoded demo URLs with actual APP_URL
        $appUrl = config('app.url') ?: url('/');
        $emailBody = str_replace('https://demo.activeitzone.com/ecommerce', $appUrl, $emailBody);
        $emailBody = str_replace('https://demo.activeitzone.com', $appUrl, $emailBody);
