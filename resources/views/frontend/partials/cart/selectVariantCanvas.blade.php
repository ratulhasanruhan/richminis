...
<div class="w-100 px-30px  position-absolute bottom-0 bg-white right-offcavas-footer pt-20px pb-20px border-top border-soft-light" style="box-shadow: none!important;">
    <div class="d-flex flex-wrap flex-md-nowrap align-items-center mb-2">
        ...
        <button id="added_to_cart_btn" type="button" onclick="addToCart()" class="rounded-1 fs-14 fw-bold py-15px px-20px w-100 add-to-cart has-transition product-details-add-cart-btn">{{ translate('Add to cart') }} <span id="add_to_cart_count"></span></button>
    </div>
    <div class="">
