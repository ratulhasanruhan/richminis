<form class="form-default" role="form" action="{{ route('billing_addresses.update', $address_data->id) }}" method="POST">
    @csrf
    <div class="p-3">
        <!-- Address -->
        <div class="row">
        ...
        <input type="hidden" name="city_id" value="{{ $address_data->city_id }}">
        @else
        <!-- City -->
        <div class="row">
            <div class="col-md-2">
