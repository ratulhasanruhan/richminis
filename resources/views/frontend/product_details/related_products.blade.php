<div class="related-product-container py-20px px-30px border bg-white border-light-gray rounded-2">
    ...
    <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
        data-xl-items="4" data-lg-items="4" data-md-items="3" data-sm-items="3" data-xs-items="2"
        ...
        @forelse (get_related_products_by_category($detailedProduct->category_id) as $key => $related_product)
            <div class="carousel-box border-right border-bottom has-transition hov-shadow-out z-1">
