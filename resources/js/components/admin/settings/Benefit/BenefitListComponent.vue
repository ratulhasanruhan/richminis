<template>
    ...
    <div class="db-card db-tab-div active">
        ...
        <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-6" v-if="benefits.length > 0">
...
import BenefitCreateComponent from "./BenefitCreateComponent";
