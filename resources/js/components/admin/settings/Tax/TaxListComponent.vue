<template>
    ...
    <div class="db-card db-tab-div active">
        ...
        <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-6" v-if="taxes.length > 0">
...
export default {
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch("tax/lists", this.props.search).then((res) => {
