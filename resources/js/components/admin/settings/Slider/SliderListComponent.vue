<template>
    ...
    <div class="db-card db-tab-div active">
        ...
        <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-6" v-if="sliders.length > 0">
...
export default {
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch("slider/lists", this.props.search).then((res) => {
        ...
        destroy: function (id) {
            appService.destroyConfirmation().then((res) => {
                try {
                    this.loading.isActive = true;
                    this.$store.dispatch("slider/destroy", {
                        id: id,
                        search: this.props.search,
                    }).then((res) => {
                        this.loading.isActive = false;
                        alertService.successFlip(null, this.$t("menu.sliders"));
                    }).catch((err) => {
                        this.loading.isActive = false;
