<template>
    ...
    <div class="db-card db-tab-div active">
        ...
        <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-6" v-if="pages.length > 0">
...
export default {
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch("page/lists", this.props.search).then((res) => {
        ...
        edit: function (page) {
            ...
            this.props.form = {
                ...
                menu_template_id: page.menu_template_id === 0 || page.menu_template_id === "" || page.menu_template_id === null ? null : page.menu_template_id,
            };
            this.loading.isActive = false;
        },
        destroy: function (id) {
